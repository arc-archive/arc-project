...
/** @typedef {import('@advanced-rest-client/requests-list').ListType} ListType */
...
export class ProjectScreenElement extends SavedListMixin(RequestsListMixin(LitElement)) {
  static get styles() {
    return [elementStyles, ListStyles, mdStyles, panelStyles];
  }
  ...
  [metaEditorTemplate]() {
    ...
    const { compatibility, editor } = this;
    return html`
    <bottom-sheet
